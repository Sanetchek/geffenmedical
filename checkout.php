...
// Получаем номер последнего заказа и дату создания заказа
$order_id = wc_get_customer_last_order($current_user->ID);
$order = wc_get_order($order_id);
$order_number = $order->get_order_number();
$order_date = $order->get_date_created()->date_i18n(get_option('date_format'));
?>

<div class="customer-info-before-checkout-form">
    <p>Привет, <?php echo esc_html($user_name); ?>!</p>
    <p>Ваш последний заказ (№<?php echo esc_html($order_number); ?>) был сделан <?php echo esc_html($order_date); ?>.</p>
</div>
...
<div class="success-payment">
  ...
  <div class="success-payment-header">
    <div class="conteiner-968">
      ...
      <div class="success-payment-header-infopayment">
        <div class="page-menu-title">Checkout</div>
        <div class="success-payment-thanks">
          <p style="text-align: right;margin-top: 0!important;">היי <span>שם פרטי</span> תודה שקנית אצלנו!</p>
        </div>

        <div class="infopayment-date-order">
          <p class="title" style="color: #0A3B64;">תאריך - </p>
          <p>10.12.23</p>
        </div>
        <div class="infopayment-order-number">
          <p class="title" style="color: #0A3B64;">מספר הזמנה - </p>
          <p>43992</p>
        </div>
      </div>
    </div>
                    ...
                    <div>
                      ...
                      <div class="woocommerce-cart-form__cart-item cart_item">
                        ...
                        <div class="product-name" data-title="מוצר">
                          ...
                          <dl class="variation">
                            <dt class="variation-">אופטיום ניאו:</dt>
                            <dd class="variation-">
                              <p>3 מארזים + מכשיר</p>
                            </dd>
                          </dl>
  ...
  <div class="success-payment-order-additionalinfo" style="margin-bottom: 210px;">
    <div class="conteiner-968">
      <div class="page-menu-title" style="border-top: 1px solid #D3D3D3;padding-top: 70px;">סיכום ההזמנה</div>
      <p class="order-additionalinfo-subtotal" style="text-align: right!important;">סכום ביניים - <span>15 ₪</span></p>
      <p class="order-additionalinfo-delivery" style="text-align: right!important;">משלוח - <span>איסוף עצמי מהמרכז
          הרפואי DMC בת”א</span></p>
      <p class="order-additionalinfo-commit" style="text-align: right!important;">הערות - <span>גגגככה</span></p>
      <p class="order-additionalinfo-total" style="text-align: right!important;">סך הכל - <span> 15 ₪</span></p>
    </div>
  </div>
