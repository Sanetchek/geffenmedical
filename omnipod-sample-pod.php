...
/**
 * Template Name: Omnipod-sample-pod
      ...
      <div class="section g-24-40 m-120">
        ...
        <div class="col-lg-5 col-sm-12">
            ...
            <div class="banner-text">
              <h2 class="omnipod-h2"><?= get_field('subtitle_main') ?></h2>
              ...
              <div class="button-omnipod-block" style="justify-content: flex-start;">
                <a href="#tab-schortcode-form" class="button-omnipod" role="button"><?= get_field('subtitle_main') ?> </a>
              </div>
            </div>
          </div>
...
<div>            <img class="use-desktop-block-mobile"
              src="/wp-content/uploads/2024/07/hero_myrte-influencer-mob.jpg" alt=""></div>
