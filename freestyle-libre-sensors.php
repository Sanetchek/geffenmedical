...
/**
 * Template Name: Freestyle libre sensors
                    ...
                    <div class="col-12 benefits-for-people">
                        ...
                        <div class="a-link" style="text-align: center;">
                            <a class="a-link__text" style="display: flex;justify-content: center;"
                                ...
                                <img style="transform: rotate(180deg);" src="/wp-content/uploads/2023/09/164412.png"
                                    alt="">
                            </a>
                        </div>
                        <?php endif ?>
                                                            ...
                                                            <div id="container-9c02237b6f" class="cmp-container">
                                                                ...
                                                                <div class="text">
                                                                    <div id="text-07ab768985" class="cmp-text">
                                                                        ...
                                                                        <h2
                                                                            style="	text-align: center;color: rgb(0,20,137);">
                                                                            <?= get_field('block7_title') ?>
                                                                        </h2>
                                                                        <div style="text-align: center;">
                                                                ...
                                                                <div class="columncontrol column-align--center">
                                                                    <div id="columncontrol-86443c681d"
                                                                        class="container">
                                                                                    ...
                                                                                    <a id="cards-b1b812c889"
                                                                                        ...
                                                                                        <div class="m-card__media">
                                                                                            <div class="m-card__wrap">
                                                                                                <div
                                                                                                    class="m-card__image">
                                                                                                    <div id="image-b1b812c889"
                                                                                                        class="cmp-image cmp-image--desktop">
                                                                                                        <?php show_image($item['image'], [300, 210], ['class' => 'cmp-image__image a-image__default']) ?>
                                                                                                        <!-- tablet Image -->
                                                                                        ...
                                                                                        <div class="m-card__body">
                                                                                            <p class="m-card__title h4">
                                                                                                <?= $item['title'] ?>
                                                                                            </p>
                                                                                            <div
                                                                                                class="m-card__description">
                                                                                                <p><?= $item['text'] ?>
                                                                                                </p>
                                                                                            </div>

                                                                                            <div
                                                                                                class="nonClickableLink nonclickablelink">
                                                                                                <p
                        ...
                        <div class="text">
                            <div id="text-e184d9b093" class="cmp-text">
                                <p><span class="disclaimer-text"><span class="color-text-gray"><span
                                                class="font-12"><strong><?= get_field('footer_title') ?></strong></span></span></span>
                                </p>
                                <p><span class="disclaimer-text"><span class="color-text-gray"><span
                                                class="font-12"><em><?= get_field('footer_subttile') ?></em></span></span></span>
                                </p>
