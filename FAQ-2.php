...
<main class="freestyle-libre-faq">
  ...
  <div id="faq_filter" class="faq-filter container">
    <h2 class="faq_title">הזינו את מונח החיפוש</h2>
    ...
    <form id="faq_filter_form" class="faq-filter-form">
      ...
      <button type="submit" id="faq-submit"><span class="faq-submit-dec"><?= get_field('submit_button') ?></span><span class="faq-submit-mob"><img src="https://geffenmedical.co.il/wp-content/uploads/2024/02/Screenshot_9.png" alt="" srcset=""></span></button>
      <button type="button" id="faq-clear"><span class="faq-clear-dec"><?= get_field('clear_filter_button') ?></span><span class="faq-clear-mob"><img src="https://geffenmedical.co.il/wp-content/uploads/2024/02/Screenshot_10.png" alt="" srcset=""></span></button>
    </form>
  </div>
