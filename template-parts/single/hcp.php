...
<div class="hcp">
  ...
  <div class="light-bg">
    <?php
      ...
      $args = [
        'customer_service' => get_field('hcp_customer_service', 'option'),
        'cs_link' => get_field('hcp_cs_link', 'option'),
        'availability_products' => get_field('hcp_availability_products', 'option'),
        'ap_link' => get_field('hcp_ap_link', 'option'),
        'joining_database' => get_field('hcp_joining_database', 'option'),
        'jd_link' => get_field('hcp_jd_link', 'option')
      ];
      ...
      $menus = get_field('hcp_menus', 'option');
