...
<div class="hcp">
  ...
  <div class="light-bg">
    <?php
      ...
      $args = [
        'customer_service' => get_field('cust_customer_service', 'option'),
        'cs_link' => get_field('cust_cs_link', 'option'),
        'availability_products' => get_field('cust_availability_products', 'option'),
        'ap_link' => get_field('cust_ap_link', 'option')
      ];
      ...
      $menus = get_field('cust_menus', 'option');
