<section class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
  <div>
    ...
    <div
      ...
      <div class="product-quantity" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>" data-id="<?= $product_id ?>">
        <?php
    ...
    <div>
      <div class="actions">
        <button type="submit" id="geffen_update_cart"
          class="button visually-hidden<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
          name="update_cart"
