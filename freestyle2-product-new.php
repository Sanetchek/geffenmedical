...
/**
 * Template Name: Freestyle2-product-new
...
<div class="librelink-app">
  <div id="container-bcee7ede1e" class="container a-container a-container--secondary a-container--gradient-center libre-product-container-bg">
    <div
      ...
      <div class="row no-gutters fl-r-revers">
        ...
        <div class="m-hero__content" data-animated="false">
          <h1 style="	color: #fff;" class="libre-product-h1"><?= get_field('title') ?></h1>
  ...
  <div class="container reader realReader">
    <div class="section g-24-40">
      <div class="row product-info-sensor product-info-sensor-color">
        <h2 style="text-align: center;"><?= get_field('block1_title') ?></h2>

        <?php $field = get_field('block1_list') ?>
        <?php if ($field): ?>
          <?php foreach ($field as $item): ?>
            <div class="col-lg-2 col-sm-12 benefits-for-people freestyle2-product-user">
	          	<div class="freestyle2-product-user-image">	
              	  <?php show_image($item['image'], [80, 100], ['width' => '80']) ?>
		          </div>
              <h3 class="freestyle2-product-user-image-title sensor-color-222731"><?= $item['title'] ?></h3>
              <p><?= $item['text'] ?></p>
            </div>
          <?php endforeach ?>
        <?php endif ?>
  ...
  <?php if ($product): ?>
    ...
    <div class="container reader realReader product-info-fl-sensor">
      <div class="section g-24-40">
        <div class="row fl2-product-sensors fl2-product-sensors-description">
          <div class="col-lg-6 col-sm-12">
            <h2 style="color:#222731"><?= $product->post_title ?></h2>
            <div class="font-18">
  ...
  <div class="container reader realReader ">
    <div class="product__bigImg product__bigImg--reader reader-page padding-zero fl2-product-sensors">
      <div class="product__bigImg-text reader-page">
        <h2 class="sensor-color-222731"><?= get_field('block6_title') ?></h2>
        <h3><?= get_field('block6_subtitle') ?></h3>
        <div class="content product__bigImg-text-content" style="font-size: 18px;"><?= get_field('block6_text') ?></div>
<div class="tutorial-videos realworldevidence-button-rt">
                          <a href="#" target="_self">
                <span>גלו את מערכת FreeStyle Libre 2</span>
              </a>
                      </div>
       <!-- <p class="apps-link">
  ...
  <div
    class="container responsivegrid a-container a-container--light aem-GridColumn aem-GridColumn--default--12 fl2-product-sensors">
                              ...
                              <div id="container-9c02237b6f" class="cmp-container">
                                ...
                                <div class="text">
                                  <div id="text-07ab768985" class="cmp-text">
                                    ...
                                    <h2 style="	text-align: center;color: #222731;margin-bottom: 8px!important;">
                                      <?= get_field('block7_title') ?></h2>
                                    <div class="text-07ab768985-p" style="text-align: center;"><?= get_field('block7_text') ?></div>
                                  </div>
                                </div>
                                <?php
                                    $faq = get_field('faq');
                                    if ($faq && isset($faq['list'])) :
                                ?>
                                        <div class="instructions-use-fl3 freestyle2-faq">
                                            <div class="accordion">
